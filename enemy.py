# class Enemy(object): This is the generic way to write below
import random
...
class Troll(Enemy):  # This is subclass of enemy
    # pass  # does nothing visually, but helps remove the syntax error the compiler with face
...
class Vampyre(Enemy):
    ...
    def phrase(self):
        print("Invite {0._name} in darling.".format(self))
